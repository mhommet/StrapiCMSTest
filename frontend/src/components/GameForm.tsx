  ...
  return (
    <div className="bg-black text-white min-h-screen p-6">
      <div className="max-w-xl mx-auto">
        <form onSubmit={handleSubmit} className="bg-[#1c1c1e] rounded-2xl p-8 border border-[#2c2c2e]">
          <h1 className="text-2xl font-bold mb-6 text-white">
            {game ? "Modifier le Jeu" : "Ajouter un Jeu"}
          </h1>
          
          <div className="mb-6">
            <label className="block text-sm uppercase tracking-wider text-gray-500 mb-2">Titre</label>
            <input
              type="text"
              name="title"
              value={formData.title}
              onChange={handleChange}
              className={`w-full p-3 bg-[#2c2c2e] border ${errors.title ? 'border-red-500' : 'border-[#3c3c3e]'} rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#0071e3] focus:border-transparent`}
              required
          ...
          <div className="mb-6">
            <label className="block text-sm uppercase tracking-wider text-gray-500 mb-2">Description</label>
            <textarea
              name="description"
          ...
          <div className="mb-6">
            <label className="block text-sm uppercase tracking-wider text-gray-500 mb-2">Date de Sortie</label>
            <input
              type="date"
              name="release_date"
          ...
          <div className="mb-8">
            <label className="block text-sm uppercase tracking-wider text-gray-500 mb-2">Genres</label>
            ...
            <div className="relative">
              ...
              {genreSearch.trim().length >= 2 && !showCreateGenre && (
                <div className="absolute z-10 w-full mt-1 bg-[#2c2c2e] border border-[#3c3c3e] rounded-lg shadow-lg max-h-60 overflow-y-auto">
                  {isSearching ? (
                    <div className="p-3 text-gray-400 text-center">Recherche en cours...</div>
                    ...
                    <div className="p-3">
                      <p className="text-gray-400 mb-2">Aucun genre trouvé pour "{genreSearch}"</p>
                      <button
                        type="button"
